...
// app.use(express.static(path.resolve(__dirname, '../public/template')))
// app.use(function(req, res){
//   res.sendFile(path.resolve(__dirname, '../public/template/index.html'));
// })
...
app.use(cors({//统一允许跨域设定
  //允许所有前端域名
  "origin": ["http://localhost:8080","http://localhost:3002","http://localhost:5000","http://127.0.0.1:8848"],  
